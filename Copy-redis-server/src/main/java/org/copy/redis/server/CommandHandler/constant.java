...
public enum constant {
    ...
    ,SRANDMEMBER("SRANDMEMBER"),SADD("SADD"),SREM("SREM"),
    SDIFF("SDIFF"),SDIFFSTORE("SDIFFSTORE"),SINTER("SINTER"),SINTERSTORE("SINTERSTORE"),
    SUNIONSTORE("SUNIONSTORE"),SUNION("SUNION"),//String
